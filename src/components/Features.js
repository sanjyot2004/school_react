  ...
  return (
    <div className='feature-block'>
      <div className='container'>
        <h1 className="display-5 fw-bold text-body-emphasis lh-1 mb-3" style={{ textAlign: "center", fontFamily: "Lucida Console" }}>Features</h1>
        <hr />
        <div className="row text-center">
          <div className="col">
            <div className="card" style={{ width: "350px", backgroundColor: "#2899B8", height: "430px" }}>
              <img src={facalty} className="card-img-top" alt="Faculty" />
          ...
          <div className="col">
            <div className="card" style={{ width: "350px", backgroundColor: "#FF7300", height: "430px" }}>
              <img src={oppo} className="card-img-top" alt="Opportunity" />
              <div className="card-body">
