    ...
    return (
      ...
      <h1 className="display-5 fw-bold text-body-emphasis lh-1 mb-3" style={{textAlign: "center"}}>Features</h1>
        ...
        <div className="row text-center">
          <div className="col">
            <div className="card" style={{width: "350px",backgroundColor:"#2899B8"}}>
          ...
          <div className="col">
            <div className="card" style={{width: "350px",backgroundColor:"#FF7300"}} >
          ...
          <div className="col">
            <div className="card" style={{width: "350px",backgroundColor:"#D0CB39"}}>
